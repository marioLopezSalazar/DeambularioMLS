...
Una vez arrancada una sesión, podemos añadir alumnado ficticio utilizando el script adjunto [`/simulador/simulador.py`](/simulador/simulador.py), para lo cual será necesario tener instalado Python en nuestro ordenador y disponer de un fichero de clave privada de la Cuenta de servicio de Firebase.
